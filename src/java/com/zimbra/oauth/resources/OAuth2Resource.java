...
public class OAuth2Resource {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response authenticate(@PathParam("client") String client, @Context UriInfo uriInfo, @CookieParam("ZM_AUTH_TOKEN") String zmAuthToken) throws GenericOAuthException {
		return OAuth2ResourceUtilities.authenticate(client, uriInfo, zmAuthToken);
	}
